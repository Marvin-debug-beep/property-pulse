...
function initializeSampleData() {
    const sampleProperties = [
        ...
        {
            id: uuidv4(),
            mlsNumber: 'CREXI-MED' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            title: 'Medical Office Building',
            address: '999 Health Center Dr',
            city: 'Atlanta',
            state: 'GA',
            zip: '30301',
            type: 'commercial',
            ...
            tenants: 15,
            occupancy: 88,
            description: 'Modern medical office fully leased to healthcare providers.',
            features: ['Medical Grade HVAC', 'Backup Generator', 'X-Ray Shielding'],
            ...
            daysOnMarket: 15,
            seller: 'Atlanta Medical Properties',
            agent: 'Healthcare CRE'
        },
        {
            id: uuidv4(),
            mlsNumber: 'LOOP-STG' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            ...
            avgRent: 140,
            occupancy: 89,
            description: 'Climate-controlled self storage with strong occupancy.',
            features: ['Climate Control', 'Security Gates', 'Video Surveillance'],
            imageUrl: 'https://images.unsplash.com/photo-1594486638281-1e4778e7f7d3?w=800',
            listedDate: new Date(Date.now() - 25 * 24 * 60 * 60 * 1000).toISOString(),
            daysOnMarket: 25,
            seller: 'Charlotte Storage Group',
            agent: 'Storage King'
        },
        {
            id: uuidv4(),
            mlsNumber: 'MULTI-48U' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            title: '48-Unit Apartment Complex',
            address: '1500 Apartment Row',
            city: 'Nashville',
            state: 'TN',
            zip: '37201',
            type: 'multifamily',
            ...
            avgRent: 1650,
            occupancy: 94,
            description: 'Class B+ multifamily in high-growth Nashville market.',
            features: ['Pool', 'Fitness Center', 'Dog Park', 'In-Unit Laundry'],
            imageUrl: 'https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=800',
            listedDate: new Date(Date.now() - 40 * 24 * 60 * 60 * 1000).toISOString(),
            daysOnMarket: 40,
            seller: 'Nashville Investment Partners',
            agent: 'Tennessee Real Estate'
        },
        {
            id: uuidv4(),
            mlsNumber: 'CREXI-HTL' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            title: 'Hotel - 120 Room',
            address: '2000 Hospitality Blvd',
            city: 'Austin',
            state: 'TX',
            zip: '78701',
            type: 'commercial',
            ...
            avgOccupancy: 72,
            ADR: 145,
            description: 'Branded hotel in prime Austin location.',
            features: ['Restaurant', 'Pool', 'Fitness Center', 'Conference Rooms'],
            imageUrl: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800',
            listedDate: new Date(Date.now() - 35 * 24 * 60 * 60 * 1000).toISOString(),
            daysOnMarket: 35,
            seller: 'Austin Hospitality Group',
            agent: 'Hotel Pros'
        },
        {
            id: uuidv4(),
            mlsNumber: 'LAND-25A' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            title: '25 Acre Industrial Land',
            address: 'Railway Industrial Park',
            city: 'Memphis',
            state: 'TN',
            zip: '38101',
            type: 'land',
            ...
            description: 'Heavy industrial zoned land with rail spur access.',
            features: ['Rail Access', 'Utilities Available', 'High Power'],
            imageUrl: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800',
            listedDate: new Date(Date.now() - 75 * 24 * 60 * 60 * 1000).toISOString(),
            daysOnMarket: 75,
            seller: 'Memphis Industrial Authority',
            agent: 'Industrial Land Specialists'
        },
        {
            id: uuidv4(),
            mlsNumber: 'RESI-LUX' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            title: 'Luxury Estate',
            address: '123 Estate Way',
            city: 'Beverly Hills',
            state: 'CA',
            zip: '90210',
            type: 'residential',
            ...
            lotSize: 0.75,
            yearBuilt: 2021,
            description: 'Ultra-luxury estate with panoramic views.',
            features: ['Pool', 'Home Theater', 'Wine Cellar', 'Smart Home'],
            imageUrl: 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800',
            listedDate: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
            daysOnMarket: 5,
            seller: 'Beverly Hills Estates',
            agent: 'Luxury Realty'
        },
        {
            id: uuidv4(),
            mlsNumber: 'CREXI-OFC' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            ...
            tenants: 35,
            occupancy: 91,
            description: 'Premium office tower in downtown Chicago.',
            features: ['LEED Platinum', 'Sky Lobby', 'Fitness Center'],
            imageUrl: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800',
            listedDate: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000).toISOString(),
            daysOnMarket: 45,
            seller: 'Chicago Tower Group',
            agent: 'Premier Commercial'
        },
        {
            id: uuidv4(),
            mlsNumber: 'MULTI-SF' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            title: '12-Unit Small Multifamily',
            ...
            avgRent: 1150,
            occupancy: 92,
            description: 'Solid small multifamily in Denver hot market.',
            features: ['Coin Laundry', 'Parking', 'Updated Units'],
            imageUrl: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800',
            listedDate: new Date(Date.now() - 18 * 24 * 60 * 60 * 1000).toISOString(),
            daysOnMarket: 18,
            seller: 'Denver Property Group',
            agent: 'Mountain State Realty'
        },
        {
            id: uuidv4(),
            mlsNumber: 'CREXI-RET' + Math.random().toString(36).substr(2, 6).toUpperCase(),
            title: 'Shopping Center - 50K SF',
            address: '1000 Retail Drive',
            city: 'Phoenix',
            state: 'AZ',
            zip: '85001',
            type: 'commercial',
            ...
            tenants: 18,
            occupancy: 95,
            description: 'Well-positioned shopping center with strong anchors.',
            features: ['Pylon Sign', 'Food Court', 'Loading Dock'],
            imageUrl: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800',
            listedDate: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(),
            daysOnMarket: 30,
            seller: 'Phoenix Retail Partners',
            agent: 'Southwest Commercial'
        }
    ];
